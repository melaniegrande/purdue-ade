...
BEGIN Scenario
    Name            AerodynamicDeorbitExperiment

BEGIN Epoch

    Epoch        1 Jun 2018 16:00:00.000000000
    SmartEpoch
	BEGIN	EVENT
			Epoch	1 Jun 2018 16:00:00.000000000
			EventEpoch
...
Start                   1 Jun 2018 16:00:00.000000000
Stop                    1 Jun 2021 16:00:00.000000000
    SmartInterval
	BEGIN	EVENTINTERVAL
			BEGIN Interval
				Start	1 Jun 2018 16:00:00.000000000
...
BEGIN Animation
    ...
    StartTime          1 Jun 2018 16:00:00.000000000
    EndTime            1 Jun 2021 16:00:00.000000000
    CurrentTime        6 Aug 2018 11:29:45.000000000
    Direction          Forward
...
END MapData
    ...
    BEGIN ClsApp
		...
		LaunchWindowStart                       -50630400.000
		LaunchWindowStop                        -145238400.000
	...
	BEGIN	EVENTINTERVAL
			BEGIN Interval
				Start	23 Oct 2016 16:00:00.000000000
				Stop	24 Oct 2016 16:00:00.000000000
			END Interval
			IntervalState	Explicit
	END	EVENTINTERVAL
...
Class Satellite
	...
	ADE_Astrogator_avg
	ADE_Astrogator_avg_Cd1p7
	ADE_Astrogator_max
	ADE_Astrogator_max_Cd1p2
	ADE_Astrogator_min
	ADE_Astrogator_min_Cd2p2
	ADE_dV1_Initial
	ADE_dV2_Intermediate
	ADE_dV3_Final
	ADE_GTO
...
BEGIN References
    Instance *
        *
    END Instance
    Instance Facility/ArizonaState
        Facility/ArizonaState
    END Instance
    Instance Facility/CalPoly
        Facility/CalPoly
    END Instance
    Instance Facility/GeorgiaTech
        Facility/GeorgiaTech
    END Instance
    Instance Facility/Purdue
        Facility/Purdue
    END Instance
    Instance Facility/UMichigan
        Facility/UMichigan
    END Instance
    Instance Facility/UtahState
        Facility/UtahState
    END Instance
    Instance Satellite/ADE_Astrogator_avg
        Satellite/ADE_Astrogator_avg
    END Instance
    Instance Satellite/ADE_Astrogator_avg_Cd1p7
        Satellite/ADE_Astrogator_avg_Cd1p7
    END Instance
    Instance Satellite/ADE_Astrogator_max
        Satellite/ADE_Astrogator_max
    END Instance
    Instance Satellite/ADE_Astrogator_max_Cd1p2
        Satellite/ADE_Astrogator_max_Cd1p2
    END Instance
    Instance Satellite/ADE_Astrogator_min
        Satellite/ADE_Astrogator_min
    END Instance
    Instance Satellite/ADE_Astrogator_min_Cd2p2
        Satellite/ADE_Astrogator_min_Cd2p2
    END Instance
    Instance Satellite/ADE_GTO
        Satellite/ADE_GTO
    END Instance
    Instance Satellite/ADE_dV1_Initial
        Satellite/ADE_dV1_Initial
    END Instance
    Instance Satellite/ADE_dV2_Intermediate
        Satellite/ADE_dV2_Intermediate
    END Instance
    Instance Satellite/ADE_dV3_Final
        Satellite/ADE_dV3_Final
    END Instance
END References
